package com.advanced.dsa.dataStructure.nonlinear.graphs.algorithums.topsorting.dikshras;
import java.util.*;
public class DijkstrasPQ { // Queue, PQ, Set
    public static List<Integer> dijkstra(int V, List<List<Pair>> adj,
                                         int S){
        // Sort the pq according to minimum distance
        PriorityQueue<Pair> pq = new PriorityQueue<>
                (Comparator.comparingInt(p -> p.distance));
        // Initially distance array has all large values (unreachable)
